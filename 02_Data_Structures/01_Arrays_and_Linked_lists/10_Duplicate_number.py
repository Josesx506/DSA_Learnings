...
# My implementation is wrong because I used the `in` method
# Also the question specifies that the numbers are consecutive from 0 to n-2, where n is the length of the array
# In other words read the question well next time
...
# Tests - I passed all the tests but missed the implementation
arr = [0, 0]
solution = 0
