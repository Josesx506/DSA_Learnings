...
both A and B. For example, the union of A = [1, 2] and B = [3, 4] is [1, 2, 3, 4].
...
the union or intersection, respectively. Once you have completed the problem you 
will create your own test cases and perform your own run time analysis on the code.
